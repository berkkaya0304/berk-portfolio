export const es = {
  ...
  work: {
    ...
    works: {
      aiPortfolio: {
        ...
        description:
          "Sitio web de portafolio personal desarrollado con Next.js y React, incorporando principios de diseño moderno.",
      },
      tributePage: {
        title: "Página de Tributo",
        description:
          "Proyecto de página de tributo desarrollado usando tecnologías web básicas.",
      },
      technicalDocs: {
      ...
      firewall: {
        title: "Cortafuegos",
        description:
          "Los incendios forestales pueden ocurrir naturalmente, pero a menudo son causados por humanos. En los últimos años, el número de incendios forestales ha aumentado día a día. Incluso en algunos países, los incendios forestales se descontrolaron. Por eso, creamos una aplicación para combatirlos: Cortafuegos.",
      },
    },
  },
  services: {
    title: "Mis Servicios",
    description:
      "Soluciones especializadas en desarrollo de software, computación en la nube y transformación digital",
    fullstack: {
    ...
    data: {
      ...
      description:
        "Transforme sus datos en bruto en información procesable con nuestras soluciones integrales de tecnología de datos. Nos especializamos en análisis, procesamiento y visualización de datos para ayudarle a tomar decisiones informadas y fomentar el crecimiento empresarial a través de estrategias basadas en datos.",
      features: [
    ...
    digitalization: {
      ...
      description:
        "Adopte la transformación digital con nuestros servicios integrales de digitalización. Ayudamos a las organizaciones a modernizar sus procesos, implementar soluciones digitales y crear flujos de trabajo eficientes que impulsen la productividad y la innovación en la era digital.",
      features: [
  ...
  resume: {
    ...
    experienceDescription:
      "En esta sección, puede encontrar información sobre mis prácticas, trabajos a tiempo parcial y a tiempo completo.",
    experienceList: [
      {
        company: "Huawei",
    ...
    educationDescription:
      "En esta sección, verá la educación que he recibido en general.",
    educationList: [
      {
    ...
    voluntarilyDescription:
      "En esta sección, puede encontrar información sobre mis trabajos voluntarios.",
    voluntarilyList: [
      {
    ...
    skillsDescription:
      "Aquí están mis habilidades técnicas y niveles de competencia.",
    softSkills: "Habilidades Blandas",
    softSkillsDescription:
      "Aquí están mis habilidades interpersonales y profesionales.",
    viewResults: "Haga clic aquí para ver todos los resultados (Turco)",
    rating: "Calificación",
    references: "Referencias",
    referencesDescription:
      "Referencias profesionales y recomendaciones de colegas y supervisores.",
    referencesList: [
      {
        name: "İlker Canbulut",
    ...
    ambassadorPrograms: [
      {
        ...
        description:
          "Soy uno de los 6 capitanes embajadores que liderarán a más de 150 embajadores este año.",
      ...
      },
      {
        ...
        description:
          "El programa de Embajadores Estudiantiles de IBM Z es una comunidad global de estudiantes universitarios apasionados por la tecnología. A través del aprendizaje práctico, la tutoría y las oportunidades de networking, los embajadores adquieren las habilidades y la experiencia que necesitan para tener éxito en la industria tecnológica.",
        level: "(Nivel 4 - Nivel Más Alto)",
      },
      {
        company: "Xbox",
        ...
        description:
          "El programa de Embajadores de Xbox es una comunidad de jugadores apasionados por hacer que los juegos sean divertidos para todos.",
        level: "Nivel 2",
      },
      {
        company: "Microsoft",
    ...
    ambassadorDescription:
      "En esta sección, puede encontrar información sobre mis programas de embajadores.",
  ...
  program: {
    ...
    programs: [
      ...
      },
      {
        ...
        description:
          "Obteniendo información sobre la Industria de Defensa en Turquía",
      ...
      },
      {
        ...
        description:
          "El Programa Da un Paso Adelante es un programa virtual de 6 meses totalmente financiado diseñado para adquirir las habilidades y la experiencia necesarias para tener éxito en los negocios.",
        skills: ["Negocios"],
      },
      {
      ...
      },
      {
        ...
        company: "Google",
        description:
          "Este viaje ha sido una oportunidad increíble para profundizar en el mundo del desarrollo de juegos y el diseño de aplicaciones, perfeccionando mis habilidades y obteniendo valiosas ideas de expertos de la industria.",
        skills: [
      ...
      },
      {
        ...
        description:
          "Tuve la oportunidad de aprender en profundidad sobre muchos aspectos de la ingeniería de software y adquirir experiencia trabajando en problemas reales durante este riguroso programa.",
  ...
  blog: {
    title: "Artículos",
    description:
      "Una colección de mis artículos y escritos sobre varios temas en tecnología y desarrollo de software.",
    filters: {
  ...
  contact: {
    ...
    description:
      "No dude en comunicarse para colaboraciones en proyectos o simplemente para una charla amistosa",
    ...
    form: {
      ...
      errorMessage:
        "Límite diario alcanzado. Por favor, inténtelo de nuevo mañana.",
    },
    info: {
