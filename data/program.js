...
const getCompanyLogo = (company) => {
  const logos = {
    ...
    "Secretariat of Defence Industries": "/assets/companies/savunmasanayibaskanligi.png",
    "Savunma Sanayii Başkanlığı": "/assets/companies/savunmasanayibaskanligi.png",
    "国防工业秘书处": "/assets/companies/savunmasanayibaskanligi.png",
    "Secretaría de Industrias de Defensa": "/assets/companies/savunmasanayibaskanligi.png",
    "Secrétariat des Industries de Défense": "/assets/companies/savunmasanayibaskanligi.png",
    "Sekretariat für Verteidigungsindustrie": "/assets/companies/savunmasanayibaskanligi.png",
    "Segretariato delle Industrie della Difesa": "/assets/companies/savunmasanayibaskanligi.png",
    "防衛産業庁": "/assets/companies/savunmasanayibaskanligi.png",
    "Secretariaat van Defensie-industrieën": "/assets/companies/savunmasanayibaskanligi.png",
    "Sekretariat Przemysłu Obronnego": "/assets/companies/savunmasanayibaskanligi.png",
    "Секретариат оборонной промышленности": "/assets/companies/savunmasanayibaskanligi.png",
