...
const MobileNav = () => {
  ...
  return (
    <Sheet open={isOpen} onOpenChange={setIsOpen}>
      ...
      <SheetContent
        side="right"
        className="bg-secondary/95 backdrop-blur-lg border-none"
      >
            ...
            {links.map((link, index) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Underline effect */}
                  <span
                    className={`absolute -bottom-0 left-0 w-0 h-[2px] bg-gradient-to-r from-blue-400 to-blue-700 transition-all duration-300 ${
