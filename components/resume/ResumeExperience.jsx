...
const ResumeExperience = () => {
  ...
  if (
    !translations.resume.experienceList ||
    translations.resume.experienceList.length === 0
  ) {
    return null;
  }

  const totalPages = Math.ceil(
    translations.resume.experienceList.length / itemsPerPage,
  );
    ...
    <div className="space-y-8">
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-blue-400/60">
          {translations.resume.experienceDescription}
        </p>
      </div>
